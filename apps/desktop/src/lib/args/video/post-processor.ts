import { FFmpegEncoderEnum, FFmpegVCodecCPUEnum } from "@grabbr/contracts/enums";
import type { FFmpegAPI } from "@grabbr/contracts/types";

export const buildPostProcessorArgs = (ppa: FFmpegAPI) => {
  const args: string[] = [];
