import { THUMB_EMBED_VIDEO_FMTS, VideoMergeOutputFormatEnum } from "@grabbr/contracts/enums";
import type { VideoPreferences } from "@grabbr/contracts/types";

import { buildPostProcessorArgs } from "./post-processor";
import { buildFormatSortArgs } from "./sorting";

export const buildVideoArgs = (video: VideoPreferences) => {
  const args: string[] = [];
